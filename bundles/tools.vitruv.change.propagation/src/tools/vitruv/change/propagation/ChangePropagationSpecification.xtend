...
interface ChangePropagationSpecification extends ChangePropagationObservable {
	 ...
	 */
	def boolean doesHandleChange(EChange change, EditableCorrespondenceModelView<Correspondence> correspondenceModel) { false }
    ...
    * 								Must not be <code>null</code>.
    */
    def void propagateNonAtomicChange(VitruviusChange change, EditableCorrespondenceModelView<Correspondence> correspondenceModel, ResourceAccess resourceAccess) {
        // noop
    }
}
